 ...
 ///////////////////////////////////////
        ...
        $(document).ready(function(){
            ...
            $('.closex').click(function(){
                var info_div = $(this.parentNode);
                info_div.hide();
                info_div[0].hide_status = true;  
            });       
           ...
           function layoutDynamically(){
                ...
                function_button_wrappers.each(function(i){
                    var top_button_position = header_height + 100;
            ...
            function_buttons.click(function(){
                ...
                function showStatisticsPane(this_id){
                ...
                if( this_id == 'next_sample' ){
                    samples_increment++// if at the end of the samples db, loop back to the beginning
                    if( samples_increment == sample_texts.length )   
                        samples_increment = 0;
                    // Paint the new text into the textarea#input_text
                    setInputBoxesText( samples_increment );
                    
                    // trigger the textbox change event so a new wordStatObject() is made, with new data to display 
                    $("textarea#input_text").trigger('change');
                    //Is the statistics popup showing?
                    if(!statistics_display[0].is_hidden)
                        //okay, then update the display's contents
                        showStatisticsPane(this_id)
